document.addEventListener('DOMContentLoaded', function() {
    ...
    // let websocket = new WebSocket(`ws://localhost:8000/ws/queryrai?token=${accessToken}`);
    let websocket = new WebSocket(`wss://api.apputa.online/ws/queryrai?token=${accessToken}`);
